...
banner() {
    ...
    printf '      ╚═╝╚═╝          ╚═════╝╚═╝╚═╝     ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝\n'
    printf '\e[1;31m       ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀\n'
    printf " \e[1;93m      IP-Cipher Ver 1.1 - by MSU [\e[1;33mDit-Dev\e[1;93m]\e[0m \n"
    printf " \e[1;92m      msue.vercel.app | github.com/Dit-eveopers \e[0m \n"
    printf "\e[1;90m IP Cipher: Securely gather encrypted data and pinpoint IP locations with precision. \e[0m \n"
}
...
local_server() {
    ...
    printf "\e[1;92m[+] Starting php server on Localhost:8080...\n"
